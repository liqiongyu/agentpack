        ...
        let envelope = JsonEnvelope::ok(
            ...
            serde_json::json!({
                ...
                "commands": {
                    ...
                    "import": { "data_fields": ["applied","reason?","repo","repo_posix","home_root","home_root_posix","project","plan","summary","next_actions"] },
                    ...
                    "status": { "data_fields": ["profile","targets","drift","summary","summary_by_root","summary_total?","next_actions?","next_actions_detailed?"] }
                },
                "path_conventions": {
